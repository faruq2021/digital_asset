...
// import digiasset from './digiasset.png';
// import enaira from './enaira.jpeg';
import Navbar from './pages/navbar';
import Hero from './pages/hero';


// console.log(digiasset); // /logo.84287d09.png
...
function App() {
	...
	<Hero/>
		...
		// 	<div class="header">
		// 		<a href="#default" class="logo"><img src={digiasset} alt="Logo" align="left"/></a>
		// 		<div class="header-right">
		// 			<a class="active" href="#home">Home</a>
		// 			<a href="#Registration link">Sign Up</a>
		...
		// 			All 37 states including Fct, subsrcibed for state Executive asset management
        ...
        // lg:px-12 bg-white bg-opacity-10 w-fit mx-auto mb-8 rounded-full">
		// 			All 37 states including Fct, subsrcibed for state Executive asset management
		// 			<img src={digiasset} alt="Logo" align="center"/>
		// 		</div>
		...
		// 				<input
		// 					placeholder="Enaira for the win..."
		// 					type="email"
		// 					name="member[email]"
		// 					id="member_email"
		...
		// 				<input
		// 					type="submit"
		// 					value="Find out more about CBDCs"
		...
		// 				Enaira the future of cashless economy<a target="_blank" href="#"
		// 					className="hover:opacity-80 duration-150"></a>
		// 				and <a target="_blank" href="#" className="hover:opacity-80 duration-150"></a>.
		// 			</div>
